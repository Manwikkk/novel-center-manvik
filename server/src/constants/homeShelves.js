...
const HOME_SHELVES = [
  ...
  { tag: 'cheering_reads', label: 'Updated Today', hint: 'Updated Today rail' },
  { tag: 'completed_novel', label: 'Completed Novels', hint: 'Lower row left' },
  { tag: 'editors_choice', label: "Editors' Choice", hint: 'Lower row right' },
  { tag: 'originals', label: 'GS Originals', hint: 'Originals rail' },
];
